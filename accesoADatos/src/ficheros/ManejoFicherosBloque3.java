...
//		Version 1 -  mas simple 
//		System.out.println("\n=== Libros y sus géneros ===");
//	    NodeList bookList = doc.getElementsByTagName("Book");
//	    String[][] libros = new String[bookList.getLength()][2];
//
//	    // Rellenar el arreglo con el título y el género
//	    for (int i = 0; i < bookList.getLength(); i++) {
//	        Element book = (Element) bookList.item(i);
//	        String genre = book.getElementsByTagName("Genre").item(0).getTextContent();
//	        String title = book.getElementsByTagName("Title").item(0).getTextContent(); 
//	        libros[i][0] = genre; // Género
//	        libros[i][1] = title; // Título
//	    }
//
//	    // Mostrar los libros con su género
//	    for (int i = 0; i < libros.length; i++) {
//	        System.out.println("Género: " + libros[i][0] + " | Título: " + libros[i][1]);
//	    }
    }
