...
public class ExploradorDeArchivosConHilos extends JFrame {
    ...
    public ExploradorDeArchivosConHilos() {
        ...
        // cargar el sistema de archivos con hilos
        ...
        // Crear el JTable para mostrar la informacion de los archivos
        ...
        add(new JButton("Actualizar"), BorderLayout.SOUTH); 

        setVisible(true);
    }
    

    //metodo para cargar el sistema de archivos en segundo plano
    ...
    //metodo del menu emergente: Abrir archivo
    ...
    //metodo del menu emergente: Renombrar
    ...
    //metodo del menu emergente: Eliminar
...
//----------------------------------------------------------------------------------------------------------------------------------------------------    
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(ExploradorDeArchivosConHilos::new);
    }
}
